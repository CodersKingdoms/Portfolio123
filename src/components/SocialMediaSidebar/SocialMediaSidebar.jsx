...
const SocialMediaSidebar = () => {
  return (
    <div className="fixed top-1/2 left-0 transform -translate-y-1/2 flex flex-col items-center space-y-6 p-2">
      <a href="https://github.com/CodersKingdoms" target="_blank" rel="noopener noreferrer" className="transform transition-transform duration-300 hover:scale-110">
        <FaGithub size={30} className="text-gray-700 hover:text-yellow-500" />
      </a>
      <a href="https://www.linkedin.com/in/abhay-mishra-488a17253/" target="_blank" rel="noopener noreferrer" className="transform transition-transform duration-300 hover:scale-110">
      ...
      <a href="https://www.instagram.com/abhaymishra_03/" target="_blank" rel="noopener noreferrer" className="transform transition-transform duration-300 hover:scale-110">
