...
import AboutImg from '../../assets/mann.png';
      ...
      <div className="md:w-1/2">
        ...
        <ul className="space-y-6">
          ...
          <li className="flex items-center gap-3">
            <IoArrowForward size={30} />
            <div>
              <h1 className="text-xl md:text-2xl font-semibold">Software Tester</h1>
              <p className="text-sm md:text-md">
              I am enriched with skills in software testing and excel as a critical thinker, capable of anticipating worst-case scenarios for any feature. I have understanding of the bug lifecycle and the processes involved in resolving defects effectively. I develop detailed and efficient test cases for Product Backlog Items (PBIs).
              </p>
            </div>
          </li>
        </ul>
